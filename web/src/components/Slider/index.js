...
const slides = [
  {
    ...
    category: "hotel",
    id: "unique-id2",
    description: "Choose your next adventure. Make unforgettable memories.",
    title: "Hotels",
  ...
  },
  {
    ...
    category: "car",
    id: "unique-id3",
    description: "Rent the perfect car for the perfect ride.",
    title: "Cars",
  ...
  },
  {
    ...
    category: "flight",
    id: "unique-id4",
    description: "Hundreds of flights discounts at once.",
    title: "Flights",
    ...
    <ReactBootstrapCarousel
      ...
      leftIcon={
        <SliderIcon
          direction="left"
          text={
            slides.find(s => s.category === props.currDisplayedCatergory)
              .prevSlideText || ""
          }
        />
      }
