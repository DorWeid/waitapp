...
class HomePage extends Component {
  ...
  componentDidMount() {
    ...
    // Reset the first displayed category - for the category lists to be in
    ...
    return (
      <div className="homepage-container">
        <TopFive items={items
          ...
          .slice(0, 6)}/>
        <Slider
          currDisplayedCatergory={currDisplayedCatergory}
